...
goog.constructNamespace_ = function (a, b, c) {
  if (!COMPILED) {
    ...
    for (
      var d = a;
      (d = d.substring(0, d.lastIndexOf("."))) && !goog.getObjectByName(d);
...
!COMPILED &&
      ...
      if (
        ...
        var d = function (h) {
          h.readyState && "complete" != h.readyState
            ? (h.onload = d)
            : (goog.Dependency.unregisterCallback_(e), a.loaded());
        };
        ...
        b.write(
          goog.TRUSTED_TYPES_POLICY_
            ? goog.TRUSTED_TYPES_POLICY_.createHTML(f)
            : f
        );
      } else {
        ...
        g.src = goog.TRUSTED_TYPES_POLICY_
  ...
  (goog.Es6ModuleDependency.prototype.load = function (a) {
    function b(l, n) {
      ...
      p && (m = ' nonce="' + p + '"');
      m = n
        ? '<script type="module" crossorigin' + m + ">" + n + "\x3c/script>"
    ...
    function c(l, n) {
      ...
      p && (m.nonce = p);
      n
        ? (m.text = goog.TRUSTED_TYPES_POLICY_
            ? goog.TRUSTED_TYPES_POLICY_.createScript(n)
            : n)
        : (m.src = goog.TRUSTED_TYPES_POLICY_
        ...
        if (f && goog.inHtmlDocument_() && goog.isDocumentLoading_() && !g) {
          ...
          h.onreadystatechange = function () {
            "interactive" == h.readyState &&
              ((h.onreadystatechange = k), c(), a.resume());
...
if (!COMPILED) {
  ...
  try {
    isChrome87 =
      eval(goog.global.trustedTypes.emptyScript) !==
...
function module$contents$goog$array_insertBefore(a, b, c) {
  var d;
  2 == arguments.length || 0 > (d = module$contents$goog$array_indexOf(a, c))
    ? a.push(b)
    : module$contents$goog$array_insertAt(a, b, d);
}
...
var module$contents$goog$array_clone = (goog.array.toArray =
...
function module$contents$goog$array_binarySearch(a, b, c) {
  return module$contents$goog$array_binarySearch_(
    a,
    c || module$contents$goog$array_defaultCompare,
    !1,
    b
  );
}
...
goog.array.inverseDefaultCompare =
  module$contents$goog$array_inverseDefaultCompare;
...
function module$contents$goog$array_concatMap(a, b, c) {
  return module$contents$goog$array_concat.apply(
    [],
    module$contents$goog$array_map(a, b, c)
  );
}
...
module$exports$goog$labs$userAgent.USE_CLIENT_HINTS = (function () {
  var a = module$contents$goog$labs$userAgent_USE_CLIENT_HINTS_OVERRIDE
...
goog.labs.userAgent.util.ASSUME_CLIENT_HINTS_SUPPORT =
  module$contents$goog$labs$userAgent$util_ASSUME_CLIENT_HINTS_SUPPORT;
...
goog.labs.userAgent.util.setUserAgentData =
  module$contents$goog$labs$userAgent$util_setUserAgentData;
          ...
          (a.promise_ = (function () {
            ...
            return $jscomp.asyncExecutePromiseGeneratorProgram(function (e) {
              if (1 == e.nextAddress)
                return (
                  e.setFinallyBlock(2),
                  e.yield(b.getHighEntropyValues([a.key_]), 4)
                );
              if (2 != e.nextAddress)
                return (
                  (d = e.yieldResult),
...
module$exports$goog$labs$userAgent$highEntropy$highEntropyValue.Version.prototype.isAtLeast =
  function (a) {
    return (
      0 <= (0, goog.string.internal.compareVersions)(this.versionString_, a)
    );
  };
var module$exports$goog$labs$userAgent$highEntropy$highEntropyData = {},
  module$contents$goog$labs$userAgent$highEntropy$highEntropyData_fullVersionListAvailable =
    !1;
...
module$exports$goog$labs$userAgent$highEntropy$highEntropyData.hasFullVersionList =
  module$contents$goog$labs$userAgent$highEntropy$highEntropyData_hasFullVersionList;
...
module$exports$goog$labs$userAgent$highEntropy$highEntropyData.setHasFullVersionListForTesting =
  module$contents$goog$labs$userAgent$highEntropy$highEntropyData_setHasFullVersionListForTesting;
...
module$exports$goog$labs$userAgent$highEntropy$highEntropyData.resetAllForTesting =
  module$contents$goog$labs$userAgent$highEntropy$highEntropyData_resetAllForTesting;
...
goog.labs.userAgent.browser.isCoast =
  module$contents$goog$labs$userAgent$browser_matchCoast;
var module$contents$goog$labs$userAgent$browser_isIosWebview =
  module$contents$goog$labs$userAgent$browser_matchIosWebview;
...
goog.labs.userAgent.browser.isVersionOrHigher =
  module$contents$goog$labs$userAgent$browser_isVersionOrHigher;
...
function module$contents$goog$labs$userAgent$browser_getFullVersionFromUserAgentString(
  ...
  if (a === module$contents$goog$labs$userAgent$browser_Brand.IE)
    return module$contents$goog$labs$userAgent$browser_matchIE()
      ? module$contents$goog$labs$userAgent$browser_getIEVersion(b)
      : "";
  ...
  return (a === module$contents$goog$labs$userAgent$browser_Brand.FIREFOX &&
    module$contents$goog$labs$userAgent$browser_matchFirefox()) ||
    (a === module$contents$goog$labs$userAgent$browser_Brand.SAFARI &&
      module$contents$goog$labs$userAgent$browser_matchSafari()) ||
    (a === module$contents$goog$labs$userAgent$browser_Brand.ANDROID_BROWSER &&
      module$contents$goog$labs$userAgent$browser_matchAndroidBrowser()) ||
    (a === module$contents$goog$labs$userAgent$browser_Brand.SILK &&
      module$contents$goog$labs$userAgent$browser_isSilk())
    ? ((a = b[2]) && a[1]) || ""
    : "";
}
...
goog.labs.userAgent.browser.versionOf =
  module$contents$goog$labs$userAgent$browser_versionOf;
...
goog.labs.userAgent.browser.isAtMost =
  module$contents$goog$labs$userAgent$browser_isAtMost;
...
var module$contents$goog$labs$userAgent$browser_UserAgentStringFallbackBrandVersion =
  function (a) {
    this.version_ =
      new module$exports$goog$labs$userAgent$highEntropy$highEntropyValue.Version(
        a
...
module$contents$goog$labs$userAgent$browser_UserAgentStringFallbackBrandVersion.prototype.getIfLoaded =
  function () {
    return this.version_;
  };
module$contents$goog$labs$userAgent$browser_UserAgentStringFallbackBrandVersion.prototype.load =
  function () {
    var a = this;
...
function module$contents$goog$labs$userAgent$browser_fullVersionOf(a) {
  if (
    ...
    return module$contents$goog$labs$userAgent$util_getUserAgentData().brands.find(
      function (c) {
        return c.brand === a;
      }
    )
      ? new module$contents$goog$labs$userAgent$browser_HighEntropyBrandVersion(
          a
        )
      : void 0;
  var b =
  ...
  return "" === b
    ? void 0
    : new module$contents$goog$labs$userAgent$browser_UserAgentStringFallbackBrandVersion(
        b
      );
}
...
goog.labs.userAgent.browser.getVersionStringForLogging =
  module$contents$goog$labs$userAgent$browser_getVersionStringForLogging;
...
goog.labs.userAgent.engine.isVersionOrHigher =
  module$contents$goog$labs$userAgent$engine_isVersionOrHigher;
...
var module$contents$goog$labs$userAgent$platform_PlatformVersion =
  function () {};
...
goog.labs.userAgent.platform.isChromecast =
  module$contents$goog$labs$userAgent$platform_isChromecast;
...
goog.labs.userAgent.platform.isVersionOrHigher =
  module$contents$goog$labs$userAgent$platform_isVersionOrHigher;
...
function module$contents$goog$object_extend(a, b) {
  for (var c, d, e = 1; e < arguments.length; e++) {
    ...
    for (
      var f = 0;
      f < module$contents$goog$object_PROTOTYPE_FIELDS.length;
      f++
    )
      (c = module$contents$goog$object_PROTOTYPE_FIELDS[f]),
...
goog.object.createImmutableView =
  module$contents$goog$object_createImmutableView;
...
goog.object.getAllPropertyNames =
  module$contents$goog$object_getAllPropertyNames;
...
goog.object.setWithReturnValueIfNotSet =
  module$contents$goog$object_setWithReturnValueIfNotSet;
...
module$contents$goog$html$SafeScript_SafeScript.unwrapTrustedScript = function (
  ...
  if (
    a instanceof module$contents$goog$html$SafeScript_SafeScript &&
...
module$contents$goog$html$SafeScript_SafeScript.createSafeScriptSecurityPrivateDoNotAccessOrElse =
  function (a) {
    ...
    return new module$contents$goog$html$SafeScript_SafeScript(
      a,
...
goog.i18n.bidi.rtlLocalesRe_ = RegExp(
...
goog.html.TrustedResourceUrl = function (a, b) {
  this.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue_ =
    b === goog.html.TrustedResourceUrl.CONSTRUCTOR_TOKEN_PRIVATE_ ? a : "";
};
...
goog.html.TrustedResourceUrl.format = function (a, b) {
  ...
  var d = c.replace(
    ...
    function (e, f) {
      ...
      var g = b[f];
      return g instanceof goog.string.Const
        ? goog.string.Const.unwrap(g)
...
goog.html.TrustedResourceUrl.BASE_URL_ = RegExp(
...
goog.html.TrustedResourceUrl.fromSafeScript = function (a) {
  a = goog.fs.blob.getBlobWithProperties(
    [module$contents$goog$html$SafeScript_SafeScript.unwrap(a)],
    "text/javascript"
  );
...
goog.html.SafeUrl = function (a, b) {
  this.privateDoNotAccessOrElseSafeUrlWrappedValue_ =
    b === goog.html.SafeUrl.CONSTRUCTOR_TOKEN_PRIVATE_ ? a : "";
};
...
goog.html.SafeUrl.tryFromDataUrl = function (a) {
  ...
  return b && goog.html.SafeUrl.isSafeMimeType(b[1])
...
module$contents$goog$html$SafeStyle_SafeStyle.fromConstant = function (a) {
  ...
  (0, goog.asserts.assert)(
    (0, goog.string.internal.endsWith)(a, ";"),
...
module$contents$goog$html$SafeStyle_SafeStyle.unwrap = function (a) {
  if (
    a instanceof module$contents$goog$html$SafeStyle_SafeStyle &&
    a.constructor === module$contents$goog$html$SafeStyle_SafeStyle
  )
...
module$contents$goog$html$SafeStyle_SafeStyle.concat = function (a) {
  var b = "",
    c = function (d) {
      Array.isArray(d)
        ? d.forEach(c)
        : (b += module$contents$goog$html$SafeStyle_SafeStyle.unwrap(d));
    };
...
function module$contents$goog$html$SafeStyle_sanitizePropertyValue(a) {
  ...
  a =
    a instanceof goog.string.Const
      ? goog.string.Const.unwrap(a)
      : module$contents$goog$html$SafeStyle_sanitizePropertyValueString(
          String(a)
        );
  if (/[{;}]/.test(a))
...
function module$contents$goog$html$SafeStyle_sanitizePropertyValueString(a) {
  ...
  if (module$contents$goog$html$SafeStyle_VALUE_RE.test(b)) {
    if (module$contents$goog$html$SafeStyle_COMMENT_RE.test(a))
      return (
        (0, goog.asserts.fail)("String value disallows comments, got: " + a),
    ...
    return (
      (0, goog.asserts.fail)(
        "String value allows only " +
          module$contents$goog$html$SafeStyle_VALUE_ALLOWED_CHARS +
...
var module$contents$goog$html$SafeStyle_VALUE_ALLOWED_CHARS =
    "[-,.\"'%_!#/ a-zA-Z0-9\\[\\]]",
  module$contents$goog$html$SafeStyle_VALUE_RE = new RegExp(
    "^" + module$contents$goog$html$SafeStyle_VALUE_ALLOWED_CHARS + "+$"
  ),
  ...
  module$contents$goog$html$SafeStyle_ALLOWED_FUNCTIONS =
    "calc cubic-bezier fit-content hsl hsla linear-gradient matrix minmax repeat rgb rgba (rotate|scale|translate)(X|Y|Z|3d)? var".split(
      " "
    ),
  module$contents$goog$html$SafeStyle_FUNCTIONS_RE = new RegExp(
    "\\b(" +
      module$contents$goog$html$SafeStyle_ALLOWED_FUNCTIONS.join("|") +
      ")\\([-+*/0-9a-zA-Z.%#\\[\\], ]+\\)",
    "g"
  ),
...
var module$contents$goog$html$SafeStyleSheet_CONSTRUCTOR_TOKEN_PRIVATE = {},
  module$contents$goog$html$SafeStyleSheet_SafeStyleSheet = function (a, b) {
    this.privateDoNotAccessOrElseSafeStyleSheetWrappedValue_ =
      b === module$contents$goog$html$SafeStyleSheet_CONSTRUCTOR_TOKEN_PRIVATE
        ? a
        : "";
    this.implementsGoogStringTypedString = !0;
  };
module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.createRule = function (
  a,
  b
) {
  ...
  b instanceof module$contents$goog$html$SafeStyle_SafeStyle ||
    (b = module$contents$goog$html$SafeStyle_SafeStyle.create(b));
  c =
    a +
    "{" +
    module$contents$goog$html$SafeStyle_SafeStyle
      ...
      .replace(/</g, "\\3C ") +
    "}";
  return module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.createSafeStyleSheetSecurityPrivateDoNotAccessOrElse(
    c
  );
};
module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.hasBalancedBrackets_ =
  ...
  var b = "",
    c = function (d) {
      Array.isArray(d)
        ? d.forEach(c)
        : (b +=
            module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.unwrap(d));
    };
  Array.prototype.forEach.call(arguments, c);
  return module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.createSafeStyleSheetSecurityPrivateDoNotAccessOrElse(
    b
...
module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.fromConstant =
  function (a) {
    a = goog.string.Const.unwrap(a);
    if (0 === a.length)
...
module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.prototype.getTypedStringValue =
  function () {
...
module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.createSafeStyleSheetSecurityPrivateDoNotAccessOrElse =
  function (a) {
    return new module$contents$goog$html$SafeStyleSheet_SafeStyleSheet(
      a,
...
var module$contents$goog$html$SafeHtml_CONSTRUCTOR_TOKEN_PRIVATE = {},
  module$contents$goog$html$SafeHtml_SafeHtml = function (a, b, c) {
    this.privateDoNotAccessOrElseSafeHtmlWrappedValue_ =
      c === module$contents$goog$html$SafeHtml_CONSTRUCTOR_TOKEN_PRIVATE
        ? a
        : "";
    this.dir_ = b;
    this.implementsGoogStringTypedString =
      this.implementsGoogI18nBidiDirectionalString = !0;
  };
module$contents$goog$html$SafeHtml_SafeHtml.prototype.getDirection =
  function () {
    return this.dir_;
  };
...
module$contents$goog$html$SafeHtml_SafeHtml.unwrap = function (a) {
  return module$contents$goog$html$SafeHtml_SafeHtml
    .unwrapTrustedHTML(a)
    .toString();
};
module$contents$goog$html$SafeHtml_SafeHtml.unwrapTrustedHTML = function (a) {
  if (
    a instanceof module$contents$goog$html$SafeHtml_SafeHtml &&
    a.constructor === module$contents$goog$html$SafeHtml_SafeHtml
  )
  ...
  function (a) {
    ...
    return module$contents$goog$html$SafeHtml_SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
      goog.string.internal.newLineToBr(
        module$contents$goog$html$SafeHtml_SafeHtml.unwrap(a)
      ),
      a.getDirection()
    );
  };
module$contents$goog$html$SafeHtml_SafeHtml.htmlEscapePreservingNewlinesAndSpaces =
  function (a) {
    if (a instanceof module$contents$goog$html$SafeHtml_SafeHtml) return a;
    a = module$contents$goog$html$SafeHtml_SafeHtml.htmlEscape(a);
    return module$contents$goog$html$SafeHtml_SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
...
module$contents$goog$html$SafeHtml_SafeHtml.verifyTagName = function (a) {
  ...
  if (
    a.toUpperCase() in module$contents$goog$html$SafeHtml_NOT_ALLOWED_TAG_NAMES
  )
    throw Error(
      module$contents$goog$html$SafeHtml_SafeHtml.ENABLE_ERROR_MESSAGES
...
module$contents$goog$html$SafeHtml_SafeHtml.createIframe = function (
  ...
  a = module$contents$goog$html$SafeHtml_SafeHtml.combineAttributes(
    e,
    { sandbox: "" },
    c
  );
...
module$contents$goog$html$SafeHtml_SafeHtml.createWithDir = function (
  a,
  b,
  c,
  d
...
module$contents$goog$html$SafeHtml_SafeHtml.join = function (a, b) {
  var c = module$contents$goog$html$SafeHtml_SafeHtml.htmlEscape(a),
    ...
    f = function (g) {
      Array.isArray(g)
        ? g.forEach(f)
        : ((g = module$contents$goog$html$SafeHtml_SafeHtml.htmlEscape(g)),
          e.push(module$contents$goog$html$SafeHtml_SafeHtml.unwrap(g)),
          (g = g.getDirection()),
          d == goog.i18n.bidi.Dir.NEUTRAL
            ? (d = g)
            : g != goog.i18n.bidi.Dir.NEUTRAL && d != g && (d = null));
    };
  b.forEach(f);
  return module$contents$goog$html$SafeHtml_SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
    e.join(module$contents$goog$html$SafeHtml_SafeHtml.unwrap(c)),
    d
  );
};
...
module$contents$goog$html$SafeHtml_SafeHtml.concatWithDir = function (a, b) {
  var c = module$contents$goog$html$SafeHtml_SafeHtml.concat(
    Array.prototype.slice.call(arguments, 1)
  );
  c.dir_ = a;
  return c;
...
module$contents$goog$html$SafeHtml_SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse =
  function (a, b, c) {
    ...
    var e =
      "<" +
      a +
      module$contents$goog$html$SafeHtml_SafeHtml.stringifyAttributes(a, b);
    ...
    goog.dom.tags.isVoidTag(a.toLowerCase())
      ? (goog.asserts.assert(
        ...
        (e += ">"))
      : ((d = module$contents$goog$html$SafeHtml_SafeHtml.concat(c)),
        (e +=
          ">" +
          module$contents$goog$html$SafeHtml_SafeHtml.unwrap(d) +
          "</" +
          a +
          ">"),
        (d = d.getDirection()));
    ...
    for (var d in b)
      if (Object.prototype.hasOwnProperty.call(b, d)) {
        ...
        null != e &&
          (c +=
            " " +
            module$contents$goog$html$SafeHtml_getAttrNameAndValue(a, d, e));
      }
  return c;
};
module$contents$goog$html$SafeHtml_SafeHtml.combineAttributes = function (
  ...
  for (g in a)
    Object.prototype.hasOwnProperty.call(a, g) &&
      (goog.asserts.assert(g.toLowerCase() == g, "Must be lower case"),
      (d[g] = a[g]));
  for (var e in b)
...
function module$contents$goog$html$SafeHtml_getStyleValue(a) {
  ...
  a instanceof module$contents$goog$html$SafeStyle_SafeStyle ||
    (a = module$contents$goog$html$SafeStyle_SafeStyle.create(a));
...
goog.dom.safe.insertAdjacentHtml = function (a, b, c) {
  a.insertAdjacentHTML(
    b,
    module$contents$goog$html$SafeHtml_SafeHtml.unwrapTrustedHTML(c)
  );
};
...
goog.dom.safe.isInnerHtmlCleanupRecursive_ = goog.functions.cacheReturnValue(
  function () {
    ...
    a.innerHTML = module$contents$goog$html$SafeHtml_SafeHtml.unwrapTrustedHTML(
      module$contents$goog$html$SafeHtml_SafeHtml.EMPTY
    );
...
goog.dom.safe.unsafeSetInnerHtmlDoNotUseOrElse = function (a, b) {
  ...
  a.innerHTML =
    module$contents$goog$html$SafeHtml_SafeHtml.unwrapTrustedHTML(b);
};
...
goog.dom.safe.setScriptContent = function (a, b) {
  goog.dom.asserts.assertIsHTMLScriptElement(a);
  a.textContent =
    module$contents$goog$html$SafeScript_SafeScript.unwrapTrustedScript(b);
  goog.dom.safe.setNonceForScriptElement_(a);
};
goog.dom.safe.setNonceForScriptElement_ = function (a) {
  var b = goog.dom.safe.getScriptNonce(
    a.ownerDocument && a.ownerDocument.defaultView
  );
...
goog.dom.safe.openInWindow = function (a, b, c, d) {
  ...
  return void 0 !== d
    ? b.open(goog.html.SafeUrl.unwrap(a), c, d)
...
goog.dom.safe.createContextualFragment = function (a, b) {
  return a.createContextualFragment(
    module$contents$goog$html$SafeHtml_SafeHtml.unwrapTrustedHTML(b)
  );
};
...
goog.dom.safe.getNonce_ = function (a, b) {
  ...
  return c.querySelector
    ? (c = c.querySelector(a)) &&
      ...
      goog.dom.safe.NONCE_PATTERN_.test(c)
      ? c
      : ""
    : "";
};
...
goog.dom.getHTMLElement = function (a) {
  return (a = goog.dom.getElement(a))
    ? goog.asserts.assertInstanceof(a, HTMLElement)
    : null;
};
...
goog.dom.getRequiredHTMLElement = function (a) {
  return goog.asserts.assertInstanceof(
    goog.dom.getRequiredElementHelper_(document, a),
    HTMLElement
  );
};
...
goog.dom.getHTMLElementByClass = function (a, b) {
  ...
  return c ? goog.asserts.assertInstanceof(c, HTMLElement) : null;
};
...
goog.dom.getRequiredHTMLElementByClass = function (a, b) {
  ...
  return goog.asserts.assertInstanceof(
    c,
    HTMLElement,
    "No HTMLElement found with className: " + a
  );
};
    ...
    for (f = e = 0; (g = a[f]); f++)
      (b = g.className),
        "function" == typeof b.split &&
          module$contents$goog$array_contains(b.split(/\s+/), c) &&
          (d[e++] = g);
    d.length = e;
    return d;
  }
...
goog.dom.append_ = function (a, b, c, d) {
  ...
  for (; d < c.length; d++) {
    ...
    goog.isArrayLike(f) && !goog.dom.isNodeLike(f)
      ? module$contents$goog$array_forEach(
          goog.dom.isNodeList(f) ? module$contents$goog$array_toArray(f) : f,
          e
        )
      : e(f);
  }
...
goog.dom.createTable_ = function (a, b, c, d) {
  for (
    var e = goog.dom.createElement_(a, goog.dom.TagName.TABLE),
      f = e.appendChild(goog.dom.createElement_(a, goog.dom.TagName.TBODY)),
      g = 0;
    g < b;
    g++
  ) {
    for (
      var h = goog.dom.createElement_(a, goog.dom.TagName.TR), k = 0;
      k < c;
      k++
    ) {
      ...
      return (
        ...
        (!c ||
          ("string" === typeof f.className &&
            module$contents$goog$array_contains(f.className.split(/\s+/), c)))
      );
    },
    !0,
    d
...
goog.style.setSafeStyleSheet = function (a, b) {
  ...
  goog.userAgent.IE && void 0 !== a.cssText
    ? (a.cssText = c)
    : goog.global.trustedTypes
    ? goog.dom.setTextContent(a, c)
    : (a.innerHTML = c);
};
...
goog.style.parseStyleAttribute = function (a) {
  ...
  a.split(/\s*;\s*/).forEach(function (c) {
    ...
    d &&
      ...
      (b[goog.string.toCamelCase(c.toLowerCase())] = d));
  });
  return b;
};
...
goog.style.MATRIX_TRANSLATION_REGEX_ = RegExp(
      ...
      try {
        if (void 0 === h) c.push("undefined");
          ...
          if (e[n]) c.push("*** reference loop detected (id=" + n + ") ***");
            ...
            c.push("{");
            for (var m in h)
              if (b || "function" !== typeof h[m])
                c.push("\n"), c.push(l), c.push(m + " = "), f(h[m], l);
            c.push("\n" + k + "}");
            delete e[n];
          }
        } else c.push(h);
...
goog.debug.exposeArray = function (a) {
  for (var b = [], c = 0; c < a.length; c++)
    Array.isArray(a[c]) ? b.push(goog.debug.exposeArray(a[c])) : b.push(a[c]);
  return "[ " + b.join(", ") + " ]";
};
...
goog.debug.serializeErrorStack_ = function (a, b) {
  ...
  var c = a.stack || "",
    d = a.cause;
  d &&
    !b[goog.debug.serializeErrorAsKey_(d)] &&
    ((c += "\nCaused by: "),
...
goog.debug.getStacktraceHelper_ = function (a, b) {
  var c = [];
  if (module$contents$goog$array_contains(b, a))
...
function module$contents$goog$disposeAll_disposeAll(a) {
  for (var b = 0, c = arguments.length; b < c; ++b) {
    var d = arguments[b];
    goog.isArrayLike(d)
      ? module$contents$goog$disposeAll_disposeAll.apply(null, d)
      : module$contents$goog$dispose_dispose(d);
  }
}
...
goog.Disposable.prototype.registerDisposable = function (a) {
  this.addOnDisposeCallback(
    goog.partial(module$contents$goog$dispose_dispose, a)
  );
};
...
goog.events.BrowserFeature = {
  ...
  PASSIVE_EVENTS: module$contents$goog$events$BrowserFeature_purify(
    function () {
...
goog.events.EventTypeHelpers.getVendorPrefixedName_ = function (a) {
...
goog.events.EventTypeHelpers.getPointerFallbackEventName_ = function (a, b, c) {
...
goog.events.ListenerMap.prototype.remove = function (a, b, c, d) {
  ...
  return -1 < b
    ? (e[b].markAsRemoved(),
      module$contents$goog$array_removeAt(e, b),
...
goog.events.handleBrowserEvent_ = function (a, b) {
  return a.removed
    ? !0
    : goog.events.fireListener(a, new goog.events.BrowserEvent(b, this));
};
...
module$contents$goog$async$WorkQueue_WorkQueue.prototype.add = function (a, b) {
  ...
  this.workTail_
    ...
    : ((0, goog.asserts.assert)(!this.workHead_), (this.workHead_ = c));
  this.workTail_ = c;
};
  ...
  if (a != goog.nullFunction)
    try {
      ...
      a.call(
        b,
        function (d) {
          c.resolve_(goog.Promise.State_.FULFILLED, d);
        },
        function (d) {
          if (goog.DEBUG && !(d instanceof goog.Promise.CancellationError))
            try {
...
goog.Promise.withResolver = function () {
  var a,
    b,
    c = new goog.Promise(function (d, e) {
      a = d;
      b = e;
    });
  ...
  d.child = new goog.Promise(function (e, f) {
    ...
    d.onRejected = b
      ? function (g) {
          try {
            var h = b.call(c, g);
            void 0 === h && g instanceof goog.Promise.CancellationError
              ? f(g)
              : e(h);
          } catch (k) {
            f(k);
...
goog.events.EventTarget.dispatchEventInternal_ = function (a, b, c) {
  ...
  b.hasPropagationStopped() ||
    ((g = b.currentTarget = a),
    (e = g.fireListeners(d, !0, b) && e),
    b.hasPropagationStopped() || (e = g.fireListeners(d, !1, b) && e));
  if (c)
    for (f = 0; !b.hasPropagationStopped() && f < c.length; f++)
...
goog.events.EventHandler.prototype.removeAll = function () {
  module$contents$goog$object_forEach(
    this.keys_,
    function (a, b) {
...
goog.ui.Component.prototype.setId = function (a) {
  this.parent_ &&
    ...
    (module$contents$goog$object_remove(this.parent_.childIndex_, this.id_),
    module$contents$goog$object_add(this.parent_.childIndex_, a, this));
  this.id_ = a;
};
...
goog.ui.Component.prototype.addChildAt = function (a, b, c) {
  ...
  (this.childIndex_ && this.children_) ||
    ((this.childIndex_ = {}), (this.children_ = []));
  a.getParent() == this
    ? (module$contents$goog$object_set(this.childIndex_, a.getId(), a),
      module$contents$goog$array_remove(this.children_, a))
    : module$contents$goog$object_add(this.childIndex_, a.getId(), a);
  a.setParent(this);
  ...
  a.inDocument_ && this.inDocument_ && a.getParent() == this
    ? ((c = this.getContentElement()),
      (c.childNodes[b] || null) != a.getElement() &&
        (a.getElement().parentElement == c && c.removeChild(a.getElement()),
        (b = c.childNodes[b] || null),
        c.insertBefore(a.getElement(), b)))
    : c
    ? (this.element_ || this.createDom(),
...
goog.ui.Component.prototype.getChild = function (a) {
  return this.childIndex_ && a
    ? module$contents$goog$object_get(this.childIndex_, a) || null
    : null;
};
...
goog.ui.Component.prototype.removeChild = function (a, b) {
  if (a) {
    ...
    c &&
      a &&
      (module$contents$goog$object_remove(this.childIndex_, c),
      module$contents$goog$array_remove(this.children_, a),
...
goog.a11y.aria.datatables.getDefaultValuesMap = function () {
  goog.a11y.aria.DefaultStateValueMap_ ||
    (goog.a11y.aria.DefaultStateValueMap_ = module$contents$goog$object_create(
...
goog.a11y.aria.TAGS_WITH_ASSUMED_ROLES_ = module$contents$goog$object_createSet(
  [
    goog.dom.TagName.A,
...
goog.a11y.aria.setRole = function (a, b) {
  b
    ? (goog.asserts.ENABLE_ASSERTS &&
        goog.asserts.assert(
          module$contents$goog$object_containsValue(goog.a11y.aria.Role, b),
          "No such ARIA role " + b
        ),
...
goog.a11y.aria.assertRoleIsSetInternalUtil = function (a, b) {
  if (!goog.a11y.aria.TAGS_WITH_ASSUMED_ROLES_[a.tagName]) {
    ...
    goog.asserts.assert(
      module$contents$goog$array_contains(b, c),
...
goog.a11y.aria.getStateBoolean = function (a, b) {
  var c = a.getAttribute(goog.a11y.aria.getAriaAttributeName_(b));
  goog.asserts.assert(
    "boolean" === typeof c || null == c || "true" == c || "false" == c
  );
...
goog.a11y.aria.getStateNumber = function (a, b) {
  var c = a.getAttribute(goog.a11y.aria.getAriaAttributeName_(b));
  goog.asserts.assert(
    (null == c || !isNaN(Number(c))) && "boolean" !== typeof c
  );
...
goog.a11y.aria.isContainerRole = function (a) {
  ...
  return module$contents$goog$array_contains(
    goog.a11y.aria.CONTAINER_ROLES_,
    a
  );
};
...
goog.a11y.aria.getAriaAttributeName_ = function (a) {
  goog.asserts.ENABLE_ASSERTS &&
    ...
    goog.asserts.assert(
      module$contents$goog$object_containsValue(goog.a11y.aria.State, a),
...
goog.dom.classlist.get = function (a) {
  return goog.dom.classlist.ALWAYS_USE_DOM_TOKEN_LIST || a.classList
    ? a.classList
    : goog.dom.classlist.getClassName_(a).match(/\S+/g) || [];
};
...
goog.dom.classlist.contains = function (a, b) {
  return goog.dom.classlist.ALWAYS_USE_DOM_TOKEN_LIST || a.classList
    ...
    : module$contents$goog$array_contains(goog.dom.classlist.get(a), b);
};
    ...
    : goog.dom.classlist.contains(a, b) &&
      goog.dom.classlist.set(
        ...
        Array.prototype.filter
          .call(goog.dom.classlist.get(a), function (c) {
            return c != b;
          })
          .join(" ")
      );
...
goog.ui.ControlRenderer.TOGGLE_ARIA_STATE_MAP_ =
  module$contents$goog$object_create(
...
goog.ui.ControlRenderer.prototype.enableClassName = function (a, b, c) {
  (a = a.getElement ? a.getElement() : a) &&
    goog.dom.classlist.enableAll(a, [b], c);
};
...
goog.ui.ControlRenderer.prototype.decorate = function (a, b) {
  ...
  c && c.firstChild
    ? a.setContentInternal(
        c.firstChild.nextSibling
          ? module$contents$goog$array_toArray(c.childNodes)
          : c.firstChild
      )
  ...
  k.forEach(function (n) {
    g || n != e
      ? h || n != f
        ? (d |= this.getStateFromClass(n))
        : (h = !0)
      : ((g = !0), f == e && (h = !0));
    this.getStateFromClass(n) == goog.ui.Component.State.DISABLED &&
  ...
  if (c && (goog.dom.removeChildren(c), b))
    if ("string" === typeof b) goog.dom.setTextContent(c, b);
      ...
      Array.isArray(b)
        ...
        ? d(b)
        : module$contents$goog$array_toArray(b).forEach(d);
    }
};
...
goog.ui.ControlRenderer.prototype.getAppliedCombinedClassNames_ = function (
  ...
  this.getIe6ClassCombinations().forEach(function (d) {
    !module$contents$goog$array_every(
      d,
      goog.partial(module$contents$goog$array_contains, a)
    ) ||
      (b && !module$contents$goog$array_contains(d, b)) ||
      c.push(d.join("_"));
  });
  return c;
};
...
goog.ui.ControlRenderer.prototype.createClassByStateMap_ = function () {
  ...
  this.classByState_ = module$contents$goog$object_create(
    goog.ui.Component.State.DISABLED,
    a + "-disabled",
...
goog.ui.ControlRenderer.prototype.createStateByClassMap_ = function () {
  this.classByState_ || this.createClassByStateMap_();
  this.stateByClass_ = module$contents$goog$object_transpose(
    this.classByState_
  );
};
...
goog.ui.Control.prototype.removeClassName = function (a) {
  a &&
    this.extraClassNames_ &&
    module$contents$goog$array_remove(this.extraClassNames_, a) &&
...
goog.ui.Control.prototype.enterDocument = function () {
  ...
  if (
    ...
    if (a) {
      ...
      b.attach(a);
      this.getHandler()
        .listen(b, goog.events.KeyEvent.EventType.KEY, this.handleKeyEvent)
...
goog.ui.Control.prototype.getCaption = function () {
  ...
  a =
    "string" === typeof a
      ? a
      : Array.isArray(a)
      ? a.map(goog.dom.getRawTextContent).join("")
...
goog.ui.Control.IeMouseEventSequenceSimulator_ = function (a) {
  ...
  this.handler_
    .listen(b, a.MOUSEDOWN, this.handleMouseDown_)
    .listen(b, a.MOUSEUP, this.handleMouseUp_)
    .listen(b, goog.events.EventType.CLICK, this.handleClick_);
};
...
goog.ui.Container.prototype.enableFocusHandling_ = function (a) {
  ...
  a
    ? b
        ...
        .listen(
          this.getKeyHandler(),
          goog.events.KeyEvent.EventType.KEY,
          this.handleKeyEvent
        )
    : b
...
goog.ui.Container.prototype.removeChild = function (a, b) {
  ...
  if (a) {
    ...
    (c = a.getElement()) &&
      c.id &&
      this.childElementIdMap_ &&
      module$contents$goog$object_remove(this.childElementIdMap_, c.id);
  }
...
goog.ui.MenuItem.prototype.getCaption = function () {
  ...
  if (Array.isArray(a)) {
    ...
    a = module$contents$goog$array_map(a, function (d) {
      return goog.dom.isElement(d) &&
        (goog.dom.classlist.contains(d, b) || goog.dom.classlist.contains(d, c))
        ? ""
        : goog.dom.getRawTextContent(d);
    }).join("");
    return goog.string.collapseBreakingSpaces(a);
  }
...
goog.ui.MenuItem.prototype.getAccelerator = function () {
  ...
  return Array.isArray(b) &&
    (b = module$contents$goog$array_find(b, function (c) {
...
goog.ui.Menu.prototype.setVisible = function (a, b, c) {
  ...
  this.openingCoords =
    a && c && "number" === typeof c.clientX
      ? new goog.math.Coordinate(c.clientX, c.clientY)
      : null;
  return b;
};
...
goog.iter.checkNoImplicitStopIterationInEs6 = function (a) {
  if (a === goog.iter.StopIteration)
    throw Error(
      "ES6 Iteration protocol does NOT adjust control flow when StopIteration is thrown from callback helper functions. If your code relies on this behavior, consider throwing a different error and catching it to terminate iteration."
    );
  throw a;
};
...
goog.iter.toIterator = function (a) {
  ...
  if (goog.isArrayLike(a)) {
    ...
    c.next = function () {
      for (;;) {
        if (b >= a.length) return goog.iter.ES6_ITERATOR_DONE;
        if (b in a) return goog.iter.createEs6IteratorYield(a[b++]);
        b++;
      }
    };
    var d = c.next;
    c.nextValueOrThrow = function () {
      return goog.iter.toEs4IteratorNext(d.call(c));
    };
    return c;
  }
...
goog.iter.forEach = function (a, b, c) {
  if (goog.isArrayLike(a))
    try {
      ...
      goog.iter.checkNoImplicitStopIterationInEs6(e);
    }
  else
    for (a = goog.iter.toIterator(a); ; ) {
      var d = void 0;
      try {
        d = a.nextValueOrThrow();
      } catch (e) {
...
goog.iter.filter = function (a, b, c) {
  ...
  e.next = function () {
    for (;;) {
      var g = void 0;
      try {
        g = d.nextValueOrThrow();
      } catch (h) {
        if (h === goog.iter.StopIteration) return goog.iter.ES6_ITERATOR_DONE;
        throw h;
      }
      try {
        if (b.call(c, g, void 0, d)) return goog.iter.createEs6IteratorYield(g);
      } catch (h) {
        goog.iter.checkNoImplicitStopIterationInEs6(h);
      }
    }
  };
  var f = e.next;
  e.nextValueOrThrow = function () {
    return goog.iter.toEs4IteratorNext(f.call(e));
  };
  return e;
};
...
goog.iter.range = function (a, b, c) {
  ...
  g.next = function () {
    ...
    var k = d;
    d += f;
    return goog.iter.createEs6IteratorYield(k);
  };
  var h = g.next;
  g.nextValueOrThrow = function () {
    return goog.iter.toEs4IteratorNext(h.call(g));
  };
  return g;
};
...
goog.iter.map = function (a, b, c) {
  ...
  e.next = function () {
    try {
      var g = d.nextValueOrThrow();
    } catch (k) {
      if (k === goog.iter.StopIteration) return goog.iter.ES6_ITERATOR_DONE;
      throw k;
    }
    try {
      var h = b.call(c, g, void 0, d);
      return goog.iter.createEs6IteratorYield(h);
    } catch (k) {
      goog.iter.checkNoImplicitStopIterationInEs6(k);
    }
  };
  var f = e.next;
  e.nextValueOrThrow = function () {
...
goog.iter.some = function (a, b, c) {
  for (a = goog.iter.toIterator(a); ; ) {
    ...
    try {
      ...
      if (e === goog.iter.StopIteration) return !1;
      throw e;
    }
    try {
      if (b.call(c, d, void 0, a)) return !0;
    } catch (e) {
      goog.iter.checkNoImplicitStopIterationInEs6(e);
    }
  }
...
goog.iter.every = function (a, b, c) {
  for (a = goog.iter.toIterator(a); ; ) {
    ...
    try {
      ...
      if (e === goog.iter.StopIteration) return !0;
      throw e;
    }
    try {
      if (!b.call(c, d, void 0, a)) return !1;
    } catch (e) {
      goog.iter.checkNoImplicitStopIterationInEs6(e);
    }
  }
...
goog.iter.chainFromIterable = function (a) {
  ...
  c.next = function () {
    for (;;) {
      if (null == d)
        try {
          var f = b.nextValueOrThrow();
          d = goog.iter.toIterator(f);
        } catch (h) {
          if (h === goog.iter.StopIteration) return goog.iter.ES6_ITERATOR_DONE;
          throw h;
        }
      try {
        var g = d.nextValueOrThrow();
        return goog.iter.createEs6IteratorYield(g);
      } catch (h) {
  ...
  var e = c.next;
  c.nextValueOrThrow = function () {
    return goog.iter.toEs4IteratorNext(e.call(c));
  };
  return c;
};
goog.iter.dropWhile = function (a, b, c) {
  ...
  e.next = function () {
    for (;;) {
      var h = void 0;
      try {
        h = d.nextValueOrThrow();
      } catch (k) {
        if (k === goog.iter.StopIteration) return goog.iter.ES6_ITERATOR_DONE;
        throw k;
      }
      if (!f || !b.call(c, h, void 0, d))
        return (f = !1), goog.iter.createEs6IteratorYield(h);
    }
  };
  var g = e.next;
  e.nextValueOrThrow = function () {
    return goog.iter.toEs4IteratorNext(g.call(e));
  };
  return e;
};
goog.iter.takeWhile = function (a, b, c) {
  ...
  e.next = function () {
    ...
    try {
      return b.call(c, g, void 0, d)
        ? goog.iter.createEs6IteratorYield(g)
...
goog.iter.product = function (a) {
  if (
    Array.prototype.some.call(arguments, function (f) {
      return !f.length;
    }) ||
    !arguments.length
  )
  ...
  b.next = function () {
    if (d) {
      for (
        var f = module$contents$goog$array_map(d, function (h, k) {
            return c[k][h];
          }),
          g = d.length - 1;
        0 <= g;
      ...
      return goog.iter.createEs6IteratorYield(f);
    }
    return goog.iter.ES6_ITERATOR_DONE;
  };
  var e = b.next;
  b.nextValueOrThrow = function () {
    return goog.iter.toEs4IteratorNext(e.call(b));
  };
  return b;
};
goog.iter.cycle = function (a) {
  ...
  e.next = function () {
    ...
    if (!f)
      try {
        return (
          (h = b.nextValueOrThrow()),
          c.push(h),
          goog.iter.createEs6IteratorYield(h)
        );
      } catch (k) {
        if (k != goog.iter.StopIteration) throw k;
        if (
          k === goog.iter.StopIteration &&
          module$contents$goog$array_isEmpty(c)
        )
          return goog.iter.ES6_ITERATOR_DONE;
        f = !0;
      }
...
goog.iter.repeat = function (a) {
  var b = new goog.iter.Iterator();
  b.next = function () {
    return goog.iter.createEs6IteratorYield(a);
  };
  var c = b.next;
  b.nextValueOrThrow = function () {
    return goog.iter.toEs4IteratorNext(c.call(b));
  };
  return b;
};
goog.iter.accumulate = function (a) {
  ...
  d.next = function () {
    try {
      c += b.nextValueOrThrow();
    } catch (f) {
      if (f === goog.iter.StopIteration) return goog.iter.ES6_ITERATOR_DONE;
      throw f;
    }
    return goog.iter.createEs6IteratorYield(c);
  };
  var e = d.next;
  d.nextValueOrThrow = function () {
    return goog.iter.toEs4IteratorNext(e.call(d));
  };
  return d;
};
goog.iter.zip = function (a) {
  ...
  if (0 < b.length) {
    var d = module$contents$goog$array_map(b, goog.iter.toIterator),
      e = !1;
    c.next = function () {
      if (e) return goog.iter.ES6_ITERATOR_DONE;
      for (var g = [], h = 0, k; (k = d[h++]); )
        try {
          g.push(k.nextValueOrThrow());
        } catch (l) {
          if (l === goog.iter.StopIteration)
            return (e = !0), goog.iter.ES6_ITERATOR_DONE;
          throw l;
        }
      return goog.iter.createEs6IteratorYield(g);
    };
    var f = c.next;
    c.nextValueOrThrow = function () {
      return goog.iter.toEs4IteratorNext(f.call(c));
    };
  }
  return c;
};
goog.iter.zipLongest = function (a, b) {
  ...
  if (0 < c.length) {
    var e = module$contents$goog$array_map(c, goog.iter.toIterator),
      f = !1;
    d.next = function () {
      if (f) return goog.iter.ES6_ITERATOR_DONE;
      for (var h = !1, k = [], l = 0, n; (n = e[l++]); )
        try {
          k.push(n.nextValueOrThrow()), (h = !0);
        } catch (m) {
          if (m !== goog.iter.StopIteration) throw m;
          k.push(a);
        }
      return h
        ? goog.iter.createEs6IteratorYield(k)
        : ((f = !0), goog.iter.ES6_ITERATOR_DONE);
    };
    var g = d.next;
    d.nextValueOrThrow = function () {
      return goog.iter.toEs4IteratorNext(g.call(d));
    };
  }
  return d;
};
  ...
  e.next = function () {
    ...
    for (;;) {
      var h = void 0,
        k = void 0;
      try {
        (h = c.nextValueOrThrow()), (k = d.nextValueOrThrow());
      } catch (l) {
        if (l === goog.iter.StopIteration)
          return (f = !0), goog.iter.ES6_ITERATOR_DONE;
        throw l;
      }
      if (k) return goog.iter.createEs6IteratorYield(h);
    }
  };
  var g = e.next;
  e.nextValueOrThrow = function () {
...
goog.iter.GroupByIterator_.prototype.next = function () {
  for (; this.currentKey == this.targetKey; ) {
    try {
      ...
      if (a === goog.iter.StopIteration) return goog.iter.ES6_ITERATOR_DONE;
      throw a;
    }
...
goog.iter.starMap = function (a, b, c) {
  ...
  e.next = function () {
    try {
      var g = goog.iter.toArray(d.nextValueOrThrow()),
        h = b.apply(c, module$contents$goog$array_concat(g, void 0, d));
      return goog.iter.createEs6IteratorYield(h);
    } catch (k) {
      if (k === goog.iter.StopIteration) return goog.iter.ES6_ITERATOR_DONE;
      throw k;
...
goog.iter.tee = function (a, b) {
  var c = goog.iter.toIterator(a),
    d = module$contents$goog$array_map(
      module$contents$goog$array_range("number" === typeof b ? b : 2),
      function () {
        return [];
      }
    );
  return module$contents$goog$array_map(d, function (e) {
    ...
    f.next = function () {
      if (module$contents$goog$array_isEmpty(e)) {
        try {
          for (var h = c.nextValueOrThrow(), k = 0, l = void 0; (l = d[k++]); )
            l.push(h);
          var n = !0;
        } catch (m) {
          if (m === goog.iter.StopIteration) n = !1;
          else throw m;
        }
        if (!n) return goog.iter.ES6_ITERATOR_DONE;
      }
      goog.asserts.assert(!module$contents$goog$array_isEmpty(e));
      return goog.iter.createEs6IteratorYield(e.shift());
    };
    var g = f.next;
    f.nextValueOrThrow = function () {
      return goog.iter.toEs4IteratorNext(g.call(f));
    };
    return f;
  });
};
...
goog.iter.limit = function (a, b) {
  ...
  d.next = function () {
    if (0 < e--)
      try {
        return goog.iter.createEs6IteratorYield(c.nextValueOrThrow());
      } catch (g) {
        if (g === goog.iter.StopIteration) return goog.iter.ES6_ITERATOR_DONE;
        throw g;
      }
    return goog.iter.ES6_ITERATOR_DONE;
  };
  var f = d.next;
  d.nextValueOrThrow = function () {
    return goog.iter.toEs4IteratorNext(f.call(d));
  };
  return d;
};
...
goog.iter.permutations = function (a, b) {
  ...
  c = module$contents$goog$array_repeat(
    c,
    "number" === typeof b ? b : c.length
  );
...
goog.iter.combinations = function (a, b) {
  ...
  var f = goog.iter.filter(e, function (k) {
      return module$contents$goog$array_isSorted(k);
    }),
    g = new goog.iter.Iterator();
  g.next = function () {
    try {
      var k = f.nextValueOrThrow();
      return goog.iter.createEs6IteratorYield(
        module$contents$goog$array_map(k, c)
      );
    } catch (l) {
      if (l === goog.iter.StopIteration) return goog.iter.ES6_ITERATOR_DONE;
      throw l;
    }
  };
  var h = g.next;
...
goog.iter.combinationsWithReplacement = function (a, b) {
  ...
  g.next = function () {
    try {
      return goog.iter.createEs6IteratorYield(
        module$contents$goog$array_map(f.nextValueOrThrow(), c)
      );
    } catch (k) {
      if (k === goog.iter.StopIteration) return goog.iter.ES6_ITERATOR_DONE;
      throw k;
...
goog.dom.TagIterator.prototype.next = function () {
  ...
  return (a = this.node)
    ? goog.iter.createEs6IteratorYield(a)
    : goog.iter.ES6_ITERATOR_DONE;
};
...
goog.dom.NodeIterator.prototype.next = function () {
  ...
  while (this.isEndTag());
  return goog.iter.createEs6IteratorYield(this.node);
};
...
goog.dom.dataset.set = function (a, b, c) {
  if (goog.dom.dataset.ALLOWED_ && a.dataset) a.dataset[b] = c;
    ...
    throw Error(
      goog.DEBUG ? '"' + b + '" is not a valid dataset property name.' : ""
    );
};
goog.dom.dataset.get = function (a, b) {
  ...
  return a.getAttribute(
    goog.dom.dataset.PREFIX_ + goog.string.toSelectorCase(b)
  );
};
goog.dom.dataset.remove = function (a, b) {
  goog.dom.dataset.isValidProperty_(b) &&
    (goog.dom.dataset.ALLOWED_ && a.dataset
      ? goog.dom.dataset.has(a, b) && delete a.dataset[b]
      : a.removeAttribute(
          goog.dom.dataset.PREFIX_ + goog.string.toSelectorCase(b)
        ));
};
goog.dom.dataset.has = function (a, b) {
  return goog.dom.dataset.isValidProperty_(b)
    ? goog.dom.dataset.ALLOWED_ && a.dataset
      ? b in a.dataset
      : a.hasAttribute
      ? a.hasAttribute(goog.dom.dataset.PREFIX_ + goog.string.toSelectorCase(b))
      : !!a.getAttribute(
          goog.dom.dataset.PREFIX_ + goog.string.toSelectorCase(b)
        )
    : !1;
...
goog.ui.PaletteRenderer.prototype.createDom = function (a) {
  ...
  goog.dom.dataset.set(
    b,
    goog.ui.PaletteRenderer.GRID_WIDTH_ATTRIBUTE,
    a.getSize().width
  );
  return b;
};
...
goog.ui.PaletteRenderer.prototype.maybeUpdateAriaLabel_ = function (a) {
  if (!goog.dom.getTextContent(a) && !goog.a11y.aria.getLabel(a)) {
    for (
      var b = new goog.dom.NodeIterator(a), c = "", d;
      !c && (d = goog.iter.nextOrValue(b, null));

    )
      d.nodeType == goog.dom.NodeType.ELEMENT &&
        (c = goog.a11y.aria.getLabel(d) || d.title);
  ...
  if (a) {
    ...
    if (c) {
          ...
          module$contents$goog$array_forEach(
            ...
            function (l) {
              ...
              if (b) {
                var n = b[d++];
                n &&
                  (goog.dom.appendChild(l, n), this.maybeUpdateAriaLabel_(l));
              }
            },
            this
          );
      ...
      if (d < b.length) {
        for (
          var e = [],
            f = goog.dom.getDomHelper(a),
            g = goog.dom.dataset.get(
              a,
              goog.ui.PaletteRenderer.GRID_WIDTH_ATTRIBUTE
            );
          d < b.length;
...
goog.ui.SelectionModel.prototype.addItems = function (a) {
  a &&
    ...
    module$contents$goog$array_extend(this.items_, a));
};
...
goog.ui.SelectionModel.prototype.addItemAt = function (a, b) {
  a &&
    ...
    module$contents$goog$array_insertAt(this.items_, a, b));
};
goog.ui.SelectionModel.prototype.removeItem = function (a) {
  a &&
    module$contents$goog$array_remove(this.items_, a) &&
...
goog.ui.Palette.prototype.handleKeyEvent = function (a) {
  ...
  if (a.keyCode == goog.events.KeyCodes.HOME)
    return this.setHighlightedIndexInternal_(0, !0), !0;
  if (a.keyCode == goog.events.KeyCodes.END)
    return this.setHighlightedIndexInternal_(b - 1, !0), !0;
  var d =
  ...
  switch (a.keyCode) {
    ...
    case goog.events.KeyCodes.UP:
      ...
      if (d >= c)
        return (
          this.setHighlightedIndexInternal_(d - c, !0), a.preventDefault(), !0
        );
      break;
    case goog.events.KeyCodes.DOWN:
      if ((-1 == d && (d = -c), d < b - c))
...
goog.ui.Palette.prototype.setHighlightedIndexInternal_ = function (a, b) {
  if (a != this.highlightedIndex_) {
    ...
    if (b && this.getParent()) {
      var c = goog.asserts.assert(
        this.getHighlightedCellElement_(),
        "Highlighted item must exist to scroll to make it visible in container. Please check that index is non-negative and valid."
      );
      goog.style.scrollIntoContainerView(
        c,
        this.getParent().getElementStrict()
      );
    }
...
goog.ui.ColorPalette.prototype.setSelectedColor = function (a) {
  ...
  this.normalizedColors_ ||
    (this.normalizedColors_ = this.colors_.map(function (b) {
...
$opensource$closure$goog$log$log$classdecl$var0.prototype.toString =
  function () {
    return this.name;
  };
...
goog.log.Level.createPredefinedLevelsCache_ = function () {
  ...
  for (var a = 0, b; (b = goog.log.Level.PREDEFINED_LEVELS[a]); a++)
    (goog.log.Level.predefinedLevelsCache_[b.value] = b),
      (goog.log.Level.predefinedLevelsCache_[b.name] = b);
};
...
goog.log.Level.getPredefinedLevelByValue = function (a) {
  goog.log.Level.predefinedLevelsCache_ ||
    goog.log.Level.createPredefinedLevelsCache_();
  if (a in goog.log.Level.predefinedLevelsCache_)
    return goog.log.Level.predefinedLevelsCache_[a];
...
$opensource$closure$goog$log$log$classdecl$var1.prototype.getName =
  function () {};
...
$opensource$closure$goog$log$log$classdecl$var2.prototype.addRecord = function (
  a,
  b,
  c
) {
...
$opensource$closure$goog$log$log$classdecl$var2.prototype.forEachRecord =
  function (a) {
    var b = this.buffer_;
    if (b[0]) {
...
$opensource$closure$goog$log$log$classdecl$var2.prototype.isBufferingEnabled =
  function () {
...
$opensource$closure$goog$log$log$classdecl$var3.prototype.reset = function (
  a,
  b,
  c,
  d,
  ...
  this.sequenceNumber_ =
    "number" === typeof e ? e : goog.log.LogRecord.nextSequenceNumber_;
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.getLoggerName =
  function () {
    return this.loggerName_;
  };
$opensource$closure$goog$log$log$classdecl$var3.prototype.setLoggerName =
  function (a) {
    this.loggerName_ = a;
  };
$opensource$closure$goog$log$log$classdecl$var3.prototype.getException =
  function () {
    return this.exception_;
  };
$opensource$closure$goog$log$log$classdecl$var3.prototype.setException =
  function (a) {
    this.exception_ = a;
  };
$opensource$closure$goog$log$log$classdecl$var3.prototype.getLevel =
  function () {
    return this.level_;
  };
$opensource$closure$goog$log$log$classdecl$var3.prototype.setLevel = function (
  a
) {
  this.level_ = a;
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.getMessage =
  function () {
    return this.msg_;
  };
$opensource$closure$goog$log$log$classdecl$var3.prototype.setMessage =
  function (a) {
    this.msg_ = a;
  };
$opensource$closure$goog$log$log$classdecl$var3.prototype.getMillis =
  function () {
    return this.time_;
  };
$opensource$closure$goog$log$log$classdecl$var3.prototype.setMillis = function (
  a
) {
  this.time_ = a;
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.getSequenceNumber =
  function () {
...
$opensource$closure$goog$log$log$classdecl$var4.prototype.getEffectiveLevel =
  function () {
...
$opensource$closure$goog$log$log$classdecl$var4.prototype.publish = function (
  a
) {
  for (var b = this; b; )
...
$opensource$closure$goog$log$log$classdecl$var5.prototype.getLogRegistryEntry =
  function (a, b) {
...
$opensource$closure$goog$log$log$classdecl$var5.prototype.getAllLoggers =
  function () {
    var a = this;
...
goog.log.getLogger = function (a, b) {
  return goog.log.ENABLED
    ? goog.log.LogRegistry_.getInstance().getLogRegistryEntry(a, b).logger
    : null;
};
...
goog.log.addHandler = function (a, b) {
  goog.log.ENABLED &&
    ...
    goog.log.LogRegistry_.getInstance()
      .getLogRegistryEntry(a.getName())
      .handlers.push(b);
};
goog.log.removeHandler = function (a, b) {
  if (goog.log.ENABLED && a) {
    var c = goog.log.LogRegistry_.getInstance().getLogRegistryEntry(
        a.getName()
      ),
...
goog.log.getLevel = function (a) {
  return goog.log.ENABLED && a
    ? goog.log.LogRegistry_.getInstance().getLogRegistryEntry(a.getName()).level
    : null;
};
...
goog.log.isLoggable = function (a, b) {
  return goog.log.ENABLED && a && b
    ? b.value >= goog.log.getEffectiveLevel(a).value
    : !1;
};
...
goog.log.log = function (a, b, c, d) {
  if (goog.log.ENABLED && a && goog.log.isLoggable(a, b)) {
    ...
    var e = goog.log.LogRegistry_.getInstance().getLogRegistryEntry(
      a.getName()
    );
...
goog.ui.tree.BaseNode = function (a, b, c) {
  ...
  this.html_ =
    module$contents$goog$html$SafeHtml_SafeHtml.htmlEscapePreservingNewlines(a);
      ...
      if ((!a && c && this.contains(c.getSelectedItem()) && this.select(), d)) {
        if ((c = this.getChildrenElement()))
          if (
            ...
            goog.dom.safe.setInnerHtml(
              c,
              module$contents$goog$html$SafeHtml_SafeHtml.concat(e)
            );
            this.forEachChild(function (f) {
              f.enterDocument();
            });
...
goog.ui.tree.BaseNode.prototype.toSafeHtml = function () {
  ...
  return module$contents$goog$html$SafeHtml_SafeHtml.create(
    "div",
...
goog.ui.tree.BaseNode.prototype.getLabelSafeHtml = function () {
  var a = module$contents$goog$html$SafeHtml_SafeHtml.create(
    "span",
    { class: this.config_.cssItemLabel, title: this.getToolTip() || null },
    this.getSafeHtml()
  );
  return module$contents$goog$html$SafeHtml_SafeHtml.concat(
    a,
    module$contents$goog$html$SafeHtml_SafeHtml.create(
      "span",
      {},
...
goog.ui.tree.BaseNode.prototype.getAfterLabelHtml = function () {
  return module$contents$goog$html$SafeHtml_SafeHtml.unwrap(
    this.getAfterLabelSafeHtml()
  );
};
...
goog.ui.tree.BaseNode.prototype.getText = function () {
  return goog.string.unescapeEntities(
    module$contents$goog$html$SafeHtml_SafeHtml.unwrap(this.html_)
  );
};
...
goog.structs.Trie.prototype.isEmpty = function () {
  return (
    void 0 === this.value_ &&
    module$contents$goog$object_isEmpty(this.childNodes_)
  );
};
...
goog.ui.tree.TypeAhead.prototype.handleTypeAheadChar = function (a) {
  ...
  if (!a.ctrlKey && !a.altKey) {
    var c = "";
    a.charCode
      ? (c = String.fromCharCode(a.charCode).toLowerCase())
      : goog.events.KeyCodes.isCharacterKey(a.keyCode) &&
        (c = String.fromCharCode(a.keyCode).toLowerCase());
    c &&
      goog.string.isUnicodeChar(c) &&
      (" " != c || this.buffer_) &&
      ((this.buffer_ += c), (b = this.jumpToLabel_(this.buffer_)));
  }
  return b;
};
...
goog.ui.tree.TreeControl.prototype.createNode = function (a) {
  return new goog.ui.tree.TreeNode(
    a || module$contents$goog$html$SafeHtml_SafeHtml.EMPTY,
    this.getConfig(),
    this.getDomHelper()
  );
};
...
goog.debug.ErrorHandler.prototype.protectEntryPoint = function (a) {
  ...
  a[b] ||
    ((a[b] = this.getProtectedFunction(a))[this.getFunctionIndex_(!1)] = a);
  return a[b];
};
  ...
  if (
    !(
      (a &&
        ...
        0 == a.message.indexOf(b)) ||
      ("string" === typeof a && 0 == a.indexOf(b))
    )
  ) {
    this.errorHandlerFn_(a);
    if (!this.wrapErrors_)
      throw (
        (this.prefixErrorMessages_ &&
          ("object" === typeof a && a && "string" === typeof a.message
        ...
        goog.DEBUG &&
          ...
          Error.captureStackTrace &&
          goog.global.console &&
          goog.global.console.error(a.message, a.stack),
        a)
      );
...
goog.debug.ErrorHandler.prototype.catchUnhandledRejections = function (a) {
  ...
  "onunhandledrejection" in a &&
    (a.onunhandledrejection = function (c) {
...
Blockly.Comment.prototype.createEditor_ = function () {
  ...
  Blockly.bindEvent_(b, "wheel", this, function (c) {
    c.stopPropagation();
  });
  Blockly.bindEvent_(b, "change", this, function (c) {
    this.text_ != b.value &&
      (Blockly.Events.fire(
...
Blockly.Connection.prototype.canConnectWithReason_ = function (a) {
  if (a) {
    if (this.sourceBlock_ && a.getSourceBlock() == this.sourceBlock_)
      return Blockly.Connection.REASON_SELF_CONNECTION;
    if (a.type != Blockly.OPPOSITE_TYPE[this.type])
      return Blockly.Connection.REASON_WRONG_TYPE;
    if (
      this.sourceBlock_ &&
      a.getSourceBlock() &&
      this.sourceBlock_.workspace !== a.getSourceBlock().workspace
    )
...
Blockly.Connection.prototype.isConnectionAllowed = function (a) {
  ...
  if (
    b != Blockly.Connection.CAN_CONNECT &&
    b != Blockly.Connection.REASON_MUST_DISCONNECT
  )
    return !1;
...
Blockly.ConnectionDB.prototype.getNeighbours = function (a, b) {
  function c(n) {
    var m = e - d[n].x_,
      p = f - d[n].y_;
    Math.sqrt(m * m + p * p) <= b && l.push(d[n]);
    return p < b;
  }
  for (
...
Blockly.Scrollbar.prototype.resizeHorizontal_ = function (a) {
  ...
  this.pair_
    ...
    : this.setVisible(b < a.contentWidth);
...
Blockly.Xml.domToBlock = function (a, b) {
  ...
  if (b.rendered) {
    ...
    c = d.getDescendants();
    for (var e = c.length - 1; 0 <= e; e--) c[e].initSvg();
...
Blockly.Xml.domToBlockHeadless_ = function (a, b) {
  ...
  (d = a.getAttribute("deletable")) && c.setDeletable("true" == d);
...
Blockly.ZoomControls.prototype.createDom = function () {
  ...
  Blockly.bindEvent_(b, "mousedown", null, function (f) {
    a.setScale(1);
    a.scrollCenter();
    f.stopPropagation();
    f.preventDefault();
  });
  Blockly.bindEvent_(e, "mousedown", null, function (f) {
    a.zoomCenter(1);
    f.stopPropagation();
    f.preventDefault();
  });
  Blockly.bindEvent_(d, "mousedown", null, function (f) {
    a.zoomCenter(-1);
    f.stopPropagation();
    f.preventDefault();
  });
...
Blockly.WorkspaceSvg.prototype.createDom = function (a) {
  ...
  var b = this;
  Blockly.bindEvent_(this.svgGroup_, "touchstart", null, function (c) {
    Blockly.longStart_(c, b);
  });
  this.options.zoomOptions &&
      ...
      do {
        ...
        if (!d)
          for (e = b.getConnections_(!1), f = 0; (g = e[f]); f++)
            if (
              g.closest(Blockly.SNAP_RADIUS, new goog.math.Coordinate(c, a))
                .connection
            ) {
              d = !0;
              break;
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function (a) {
  function b(p) {
    if (p.isDeletable()) m = m.concat(p.getDescendants());
    else {
      p = p.getChildren();
      for (var q = 0; q < p.length; q++) b(p[q]);
    }
  }
  function c() {
    Blockly.Events.setGroup(f);
    var p = m.shift();
    p && (p.workspace ? (p.dispose(!1, !0), setTimeout(c, 10)) : c());
    Blockly.Events.setGroup(!1);
  }
  if (!this.options.readOnly && !this.isFlyout) {
    ...
    if (this.options.collapse) {
      for (var h = (g = !1), k = 0; k < e.length; k++)
        for (var l = e[k]; l; )
          l.isCollapsed() ? (g = !0) : (h = !0), (l = l.getNextBlock());
      var n = function (p) {
        for (var q = 0, r = 0; r < e.length; r++)
          for (var t = e[r]; t; )
            setTimeout(t.setCollapsed.bind(t, p), q),
              (t = t.getNextBlock()),
              (q += 10);
      };
      h = { enabled: h };
    ...
    var m = [];
    for (k = 0; k < e.length; k++) b(e[k]);
    g = {
      text:
        1 == m.length
          ? Blockly.Msg.DELETE_BLOCK
          : Blockly.Msg.DELETE_X_BLOCKS.replace("%1", String(m.length)),
      enabled: 0 < m.length,
      callback: function () {
        (2 > m.length ||
          window.confirm(
            Blockly.Msg.DELETE_ALL_BLOCKS.replace("%1", String(m.length))
          )) &&
          c();
      },
    };
...
Blockly.WorkspaceSvg.prototype.updateGridPattern_ = function () {
  if (this.options.gridPattern) {
    ...
    a = Math.floor(this.options.gridOptions.spacing / 2) + 0.5;
...
Blockly.Block.prototype.getInstances = function (a) {
  for (var b = [], c = 0, d; (d = this.inputList[c]); c++)
    for (var e = 0, f; (f = d.fieldRow[e]); e++)
      f instanceof Blockly.FieldInstance &&
        (f = a ? f.getInstanceTypeValue(a) : f.getValue()) &&
        b.push(f);
  return b;
};
...
Blockly.BlockSvg.prototype.initSvg = function () {
  ...
  if (!this.workspace.options.readOnly && !this.eventsInit_) {
    ...
    var c = this;
    Blockly.bindEvent_(this.getSvgRoot(), "touchstart", null, function (d) {
      Blockly.longStart_(d, c);
    });
  }
  this.eventsInit_ = !0;
...
Blockly.BlockSvg.prototype.showContextMenu_ = function (a) {
  ...
  if (!this.workspace.options.readOnly && this.contextMenu) {
    var c = this,
      d = [];
    if (this.isDeletable() && this.isMovable() && !c.isInFlyout) {
      var e = {
        text: Blockly.Msg.DUPLICATE_BLOCK,
        enabled: !0,
        callback: function () {
          Blockly.duplicate_(c);
        },
      };
      ...
      if (!this.collapsed_)
        for (e = 1; e < this.inputList.length; e++)
          if (
            this.inputList[e - 1].type != Blockly.NEXT_STATEMENT &&
            this.inputList[e].type != Blockly.NEXT_STATEMENT
          ) {
            e = { enabled: !0 };
            var f = this.getInputsInline();
            e.text = f
      ...
      this.workspace.options.collapse &&
        (this.collapsed_
          ? ((e = { enabled: !0 }),
            (e.text = Blockly.Msg.EXPAND_BLOCK),
            (e.callback = function () {
              c.setCollapsed(!1);
            }),
            d.push(e))
          : ((e = { enabled: !0 }),
            (e.text = Blockly.Msg.COLLAPSE_BLOCK),
            (e.callback = function () {
              c.setCollapsed(!0);
            }),
            d.push(e)));
      this.workspace.options.disable &&
        ...
        d.push(e));
      e = this.getDescendants().length;
      var g = this.getNextBlock();
      g && (e -= g.getDescendants().length);
      e = {
        text:
          1 == e
            ? Blockly.Msg.DELETE_BLOCK
    ...
    d.push({
      text: this.movable_ ? "Set to Not Movable" : "Set to Movable",
      enabled: b,
      callback: function () {
        c.setMovable(!c.movable_);
      },
    });
    d.push({
      ...
      enabled: b,
      callback: function () {
        c.setEditable(!c.editable_);
        c.setDeletable(!c.deletable_);
      },
    });
    b = {
    ...
    b.text = Blockly.Msg.HELP;
    b.callback = function () {
      c.showHelp_();
    };
    d.push(b);
    this.customContextMenu && !c.isInFlyout && this.customContextMenu(d);
    Blockly.ContextMenu.show(a, d, this.RTL);
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function (a, b, c, d, e, f, g) {
  for (var h, k = 0, l, n, m = 0, p; (p = f[m]); m++) {
    ...
    if (this.isCollapsed()) {
      ...
      a.push("v", q);
      this.RTL &&
        (b.push("v 3.9 l 7.2,3.4 m -14.5,8.9 l 7.3,3.5"), b.push("v", q - 0.7));
      ...
      for (var r = 0; (q = p[r]); r++)
        (l = k),
          ...
          (h = this.renderFields_(q.fieldRow, h, l)),
          q.type != Blockly.DUMMY_INPUT &&
            (h += q.renderWidth + Blockly.BlockSvg.SEP_SPACE_X),
          q.type == Blockly.INPUT_VALUE &&
            (c.push(
              "M",
              h -
                Blockly.BlockSvg.SEP_SPACE_X +
            ...
            c.push("h", Blockly.BlockSvg.TAB_WIDTH - 2 - q.renderWidth),
            c.push(Blockly.BlockSvg.TAB_PATH_DOWN),
            c.push("v", q.renderHeight + 1 - Blockly.BlockSvg.TAB_HEIGHT),
            c.push("h", q.renderWidth + 2 - Blockly.BlockSvg.TAB_WIDTH),
            c.push("z"),
            this.RTL
              ? (d.push(
                  "M",
                ...
                d.push("v", q.renderHeight - Blockly.BlockSvg.TAB_HEIGHT + 2.5),
                d.push("h", q.renderWidth - Blockly.BlockSvg.TAB_WIDTH + 2))
              : (d.push(
                  "M",
                  h -
                    Blockly.BlockSvg.SEP_SPACE_X +
                ...
                d.push("v", q.renderHeight + 1),
                d.push("h", Blockly.BlockSvg.TAB_WIDTH - 2 - q.renderWidth),
                d.push(
                  "M",
                  h -
                    q.renderWidth -
            ...
            (l = this.RTL
              ...
              : e.x +
                ...
                q.renderWidth -
                1),
            (n = e.y + k + Blockly.BlockSvg.INLINE_PADDING_Y + 1),
            q.connection.moveTo(l, n),
            q.connection.isConnected() && q.connection.tighten_());
      ...
      p.type == Blockly.INPUT_VALUE
        ? ((q = p[0]),
          (l = k),
          q.align != Blockly.ALIGN_LEFT &&
            ((r =
              f.rightEdge -
              q.fieldWidth -
              Blockly.BlockSvg.TAB_WIDTH -
              2 * Blockly.BlockSvg.SEP_SPACE_X),
            q.align == Blockly.ALIGN_RIGHT
              ? (h += r)
              : q.align == Blockly.ALIGN_CENTRE && (h += r / 2)),
          this.renderFields_(q.fieldRow, h, l),
          ...
          (n = e.y + k),
          q.connection.moveTo(l, n),
          q.connection.isConnected() &&
            (q.connection.tighten_(),
            (this.width = Math.max(
              this.width,
              f.rightEdge +
        ...
        ? ((q = p[0]),
          ...
          q.align != Blockly.ALIGN_LEFT &&
            ((r =
              f.rightEdge - q.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X),
...
Blockly.Events.filter = function (a, b) {
  var c = module$contents$goog$array_toArray(a);
  b || c.reverse();
...
Blockly.FieldTextInput.prototype.showEditor_ = function (a) {
  ...
  if (
    ...
    var c = goog.dom.createDom("input", "blocklyHtmlInput");
...
Blockly.FieldAngle.prototype.setValidator = function (a) {
  Blockly.FieldAngle.superClass_.setValidator.call(
    this,
    a
      ? function (b) {
          var c = a.call(this, b);
...
Blockly.FieldAngle.prototype.onMouseMove = function (a) {
  ...
  isNaN(b) ||
    ...
    (b = Blockly.FieldAngle.angleValidator(b)),
...
Blockly.FieldDropdown.prototype.showEditor_ = function () {
  ...
  b.getHandler().listen(
    ...
    goog.events.EventType.TOUCHSTART,
    function (k) {
      this.getOwnerControl(k.target).handleMouseDown(k);
    }
  );
  b.getHandler().listen(
    b.getElement(),
    goog.events.EventType.TOUCHEND,
    function (k) {
      this.getOwnerControl(k.target).performActionInternal(k);
    }
  );
...
Blockly.Instances.allInstancesOf = function (a, b) {
  if (b.getAllBlocks) var c = b.getAllBlocks();
...
Blockly.Instances.isInstancePresent = function (a, b, c) {
  if (c.workspace && c.workspace.getAllBlocks)
    var d = c.workspace.getAllBlocks();
...
Blockly.Instances.generateUniqueName = function (a) {
  a = Blockly.Variables.allVariables(a).concat(
    Blockly.Instances.allInstances(a)
  );
  var b = "";
  if (a.length)
...
Blockly.Instances.convertToUniqueName = function (a, b) {
  var c = Blockly.Variables.allVariables(b).concat(
    Blockly.Instances.allInstances(b)
  );
  return Blockly.Instances.appendToName_(a, c);
};
Blockly.Instances.convertToUniqueNameBlock = function (a, b) {
  if (b.workspace) var c = b.workspace.getAllBlocks();
...
Blockly.bindEvent_ = function (a, b, c, d) {
  ...
  if (b in Blockly.bindEvent_.TOUCH_MAP) {
    ...
    for (var g = 0, h; (h = Blockly.bindEvent_.TOUCH_MAP[b][g]); g++)
...
Blockly.FieldInstance.prototype.setValidator = function (a) {
  Blockly.FieldInstance.superClass_.setValidator.call(
    this,
    a
      ? function (b) {
          var c = a.call(this, b);
          if (null === c) var d = c;
            ...
            void 0 === c && (c = b),
              (d = Blockly.FieldInstance.dropdownChange.call(this, c)),
              void 0 === d && (d = c);
          return d === b ? void 0 : d;
        }
...
Blockly.FieldInstance.prototype.init = function () {
  if (!this.fieldGroup_) {
    ...
    var a = this.sourceBlock_.isInFlyout
    ...
    this.getValue()
      ? this.uniqueName_
        ...
        : (a = Blockly.Instances.getAnyInstanceOf(this.instanceType_, a)) &&
          this.setValue(a)
      : this.setValue(Blockly.Instances.generateUniqueName(a));
  }
};
...
Blockly.FieldInstance.prototype.dropdownCreate = function () {
  var a =
      this.sourceBlock_ && this.sourceBlock_.workspace
        ? Blockly.Instances.allInstancesOf(
            this.instanceType_,
            this.sourceBlock_.workspace
          )
        : [],
  ...
  var c = this.editDropdownData ? this.editDropdownData(c) : [];
  for (b = 0; b < a.length; b++) c[b] = [a[b], a[b]];
  return c;
};
Blockly.FieldInstance.dropdownChange = function (a) {
  function b(f, g, h) {
    Blockly.hideChaff();
    Blockly.prompt(f, g, function (k) {
      k &&
        ((k = k.replace(/[\s\xa0]+/g, " ").replace(/^ | $/g, "")),
        k == Blockly.Msg.RENAME_INSTANCE || k == Blockly.Msg.NEW_INSTANCE) &&
        (k = null);
      h(k);
    });
  }
  ...
  if (a == Blockly.Msg.RENAME_INSTANCE) {
    var d = this.getText(),
      e = this;
    b(Blockly.Msg.RENAME_INSTANCE_TITLE.replace("%1", d), d, function (f) {
      f && Blockly.Instances.renameInstance(d, f, e.instanceType_, c);
    });
    return null;
  }
  if (a == Blockly.Msg.NEW_INSTANCE)
    return Blockly.Instances.generateUniqueName(c);
};
...
Blockly.Variables.flyoutCategory = function (a) {
  ...
  a.sort(goog.string.caseInsensitiveCompare);
  module$contents$goog$array_remove(a, Blockly.Msg.VARIABLES_DEFAULT_NAME);
  ...
  for (var b = [], c = 0; c < a.length; c++) {
    ...
    Blockly.Blocks.variables_get &&
      ...
      Blockly.Blocks.variables_set && d.setAttribute("gap", 24),
      (e = goog.dom.createDom("field", null, a[c])),
      e.setAttribute("name", "VAR"),
      d.appendChild(e),
      b.push(d));
  }
...
Blockly.FieldVariable.prototype.setValidator = function (a) {
  Blockly.FieldVariable.superClass_.setValidator.call(
    this,
    a
      ? function (b) {
          var c = a.call(this, b);
...
Blockly.FieldVariable.dropdownChange = function (a) {
  function b(e, f, g) {
    Blockly.hideChaff();
    Blockly.prompt(e, f, function (h) {
      h &&
        ((h = h.replace(/[\s\xa0]+/g, " ").replace(/^ | $/g, "")),
        h == Blockly.Msg.RENAME_VARIABLE || h == Blockly.Msg.NEW_VARIABLE) &&
        (h = null);
      g(h);
    });
  }
  ...
  if (a == Blockly.Msg.RENAME_VARIABLE) {
    var d = this.getText();
    b(Blockly.Msg.RENAME_VARIABLE_TITLE.replace("%1", d), d, function (e) {
      e && Blockly.Variables.renameVariable(d, e, c);
    });
    return null;
  }
  if (a == Blockly.Msg.NEW_VARIABLE)
    return Blockly.Variables.generateUniqueName(c);
};
...
Blockly.Generator.prototype.valueToCode = function (a, b, c) {
  ...
  d = d[1];
  isNaN(d) &&
    goog.asserts.fail('Expecting valid order from value block "%s".', a.type);
...
Blockly.Type = function (a) {
  if (
    void 0 === a.typeId ||
    void 0 === a.typeMsgName ||
    void 0 === a.compatibleTypes
  )
    throw Error(
  ...
  if (!goog.isArray(a.compatibleTypes))
    throw Error(
      "The compatible types for a Blockly Types needs to be an array of Blockly.Type items."
    );
  this.typeId = a.typeId;
  this.typeMsgName_ = a.typeMsgName;
...
Blockly.Type.prototype.generateCheckList_ = function (a) {
  ...
  for (a = 0; a < this.compatibleTypes_.length; a++) {
    for (var b = !0, c = 0; c < this.generatedCheckList_.length; c++)
      this.generatedCheckList_[c] === this.compatibleTypes_[a].typeId &&
        (b = !1);
    b && this.generatedCheckList_.push(this.compatibleTypes_[a].typeId);
  }
};
Blockly.Type.prototype.addCompatibleType = function (a) {
  if (!(a && a.constructor && a instanceof Blockly.Type))
    throw Error(
      "To add a compatible type to " +
        this.typeId +
...
Blockly.Type.prototype.addCompatibleTypes = function (a) {
  if (!goog.isArray(a))
    throw Error(
      "To add compatible types to the Blockly Type " +
        this.typeId +
        " provide an array of Blockly.Type items."
    );
  for (var b = 0; b < a.length; b++) {
    if (!(a[b] && a[b].constructor && a[b] instanceof Blockly.Type))
      throw Error(
        "To add a compatible type to " +
          this.typeId +
          " you must point to a Blockly.Type object."
      );
...
Blockly.Types.addType = function (a, b, c) {
  ...
  if (void 0 !== Blockly.Types[d])
    throw "The Blockly type " + d + " already exists.";
...
Blockly.Types.getChildBlockType = function (a) {
  for (
    var b = a;
    b &&
    void 0 === b.getBlockType &&
    0 < b.inputList.length &&
    b.inputList[0].connection;

  )
    b = b.inputList[0].connection.targetBlock();
  return b === a
    ? Blockly.Types.CHILD_BLOCK_MISSING
    : null === b
    ? Blockly.Types.CHILD_BLOCK_MISSING
    : b.getBlockType
    ? b.getBlockType()
...
Blockly.Types.identifyNumber = function (a) {
  return Blockly.Types.regExpInt_.test(a)
    ? ((a = parseInt(a)),
      isNaN(a)
        ? Blockly.Types.NULL
        : 32767 < a || -32768 > a
        ? Blockly.Types.LARGE_NUMBER
        : Blockly.Types.NUMBER)
    : Blockly.Types.regExpFloat_.test(a)
    ? Blockly.Types.DECIMAL
    : Blockly.Types.NULL;
};
...
Blockly.StaticTyping.prototype.collectVarsWithTypes = function (a) {
  ...
  for (var b = 0; b < a.length; b++)
    for (
      var c = Blockly.StaticTyping.getBlockVars(a[b]), d = 0;
      d < c.length;
      d++
    ) {
      var e = c[d][0],
        f = c[d][1];
      goog.isArray(f) &&
        (this.varTypeDict[f[1]]
          ? (f = this.varTypeDict[f[1]])
          : (goog.isArray(this.pendingVarTypeDict[f[1]])
...
Blockly.StaticTyping.getAllStatementsOrdered = function (a) {
  ...
  var b = function (e) {
      ...
      do {
        g.push(e);
        var h = e.nextConnection;
        var k = e.getConnections_();
        e = null;
        for (var l = 0; l < k.length; l++)
          k[l].type == Blockly.NEXT_STATEMENT &&
            (f = k[l].targetBlock()) &&
            (k[l] === h ? (e = f) : (g = g.concat(b(f))));
      } while (e);
      return g;
    },
    c = [];
  ...
  if (c) {
    ...
    for (var d = 0; d < c.length; d++) {
      var e = c[d],
        f = a.getVarType;
      f
        ? ((f = f.call(a, e)), b.push([e, f]))
        : b.push([e, Blockly.Types.NULL]);
    }
  }
  return b;
};
  ...
  switch (this.varTypeDict[b]) {
    ...
    case Blockly.Types.UNDEF:
      ...
      if (c != Blockly.Types.UNDEF && void 0 !== this.pendingVarTypeDict[b])
        for (var d = 0; d < this.pendingVarTypeDict[b].length; d++)
          this.assignTypeToVars(a, this.pendingVarTypeDict[b][d], c);
      break;
    default:
...
Blockly.StaticTyping.prototype.setBlockTypeWarning = function (a, b, c) {
  b == Blockly.Types.CHILD_BLOCK_MISSING ||
  this.varTypeDict[c] == Blockly.Types.CHILD_BLOCK_MISSING
    ? a.setWarningText(null, "varType")
    : this.varTypeDict[c] !== b && b !== Blockly.Types.UNDEF
    ? a.setWarningText(
        "The variable " +
          c +
          ' has been first assigned to the "' +
          this.varTypeDict[c].typeName +
          '" type\nand this block tries to assign the type "' +
          b.typeName +
          '"!',
        "varType"
      )
...
Blockly.Procedures.rename = function (a) {
  ...
  for (
    ...
    b[c].renameProcedure && b[c].renameProcedure(this.text_, a);
  return a;
};
Blockly.Procedures.flyoutCategory = function (a) {
  ...
  if (Blockly.Blocks.arduino_functions) {
    ...
    for (var e = a.getTopBlocks(), f = 0; f < e.length; f++)
      e[f].getArduinoLoopsInstance &&
        e[f].getArduinoLoopsInstance() &&
...
Blockly.Flyout.prototype.show = function (a) {
  ...
  this.listeners_.push(
    Blockly.bindEvent_(this.svgBackground_, "mouseover", this, function (g) {
      g = this.workspace_.getTopBlocks(!1);
      for (var h = 0, k; (k = g[h]); h++) k.removeSelect();
    })
  );
...
Blockly.Flyout.prototype.layoutBlocks_ = function (a, b) {
  for (
    var c = this.MARGIN * this.workspace_.scale,
...
Blockly.Flyout.prototype.addBlockListeners_ = function (a, b, c) {
  this.autoClose
    ? (this.listeners_.push(
        Blockly.bindEvent_(a, "mousedown", null, this.createBlockFunc_(b))
      ),
      this.listeners_.push(
        Blockly.bindEvent_(c, "mousedown", null, this.createBlockFunc_(b))
      ))
    : (this.listeners_.push(
...
Blockly.Flyout.prototype.onMouseUp_ = function (a) {
  Blockly.dragMode_ == Blockly.DRAG_FREE ||
    Blockly.WidgetDiv.isVisible() ||
    Blockly.Events.fire(
      new Blockly.Events.Ui(Blockly.Flyout.startBlock_, "click", void 0, void 0)
    );
  Blockly.terminateDrag_();
};
...
Blockly.Flyout.prototype.onMouseMoveBlock_ = function (a) {
  if (
    ...
    Math.sqrt(b * b + a * a) > Blockly.DRAG_RADIUS &&
      ...
      d.moveBy(b, 0),
        d.flyoutRect_ &&
          d.flyoutRect_.setAttribute(
            "x",
            b + Number(d.flyoutRect_.getAttribute("x"))
          );
  }
};
...
Blockly.Toolbox.prototype.init = function (a, b) {
  a = this.workspace_;
  this.HtmlDiv = goog.dom.createDom("div", "blocklyToolboxDiv");
  this.HtmlDiv.setAttribute("dir", a.RTL ? "RTL" : "LTR");
  b.appendChild(this.HtmlDiv);
  Blockly.bindEvent_(this.HtmlDiv, "mousedown", this, function (d) {
    Blockly.isRightButton(d) || d.target == this.HtmlDiv
      ? Blockly.hideChaff(!1)
      : Blockly.hideChaff(!0);
  });
  this.flyout_ = new Blockly.Flyout({
  ...
  var c = new Blockly.Toolbox.TreeControl(this, this.config_);
  this.tree_ = c;
  c.setShowRootNode(!1);
  c.setShowLines(!1);
      ...
      ? ((a.style.left = c.x + "px"),
        ...
        (a.style.top =
          this.toolboxPosition == Blockly.TOOLBOX_AT_TOP
            ? c.y + "px"
            : c.y + b.height - a.offsetHeight + "px"))
      : (this.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT &&
          (a.style.left = c.x + b.width - a.offsetWidth + "px"),
        (a.style.height = b.height + "px"),
        (a.style.top = a.parentElement.offsetTop + "px"),
        (this.width = a.offsetWidth),
        this.toolboxPosition == Blockly.TOOLBOX_AT_LEFT && --this.width);
    this.flyout_.position();
  }
};
Blockly.Toolbox.prototype.populate_ = function (a) {
  function b(f, g, h) {
    for (var k = null, l = 0, n; (n = f.childNodes[l]); l++)
      if (n.tagName)
        switch (n.tagName.toUpperCase()) {
          case "CATEGORY":
            ...
            k.blocks = [];
            g.add(k);
            var m = n.getAttribute("custom");
            m ? (k.blocks = m) : b(n, k, h);
            m = n.getAttribute("colour");
            goog.isString(m)
              ? (m.match(/^#[0-9a-fA-F]{6}$/)
                  ? (k.hexColour = m)
                  : (k.hexColour = Blockly.hueToRgb(m)),
                (e = !0))
              : (k.hexColour = "");
            "true" == n.getAttribute("expanded")
              ? (k.blocks.length && c.setSelectedItem(k), k.setExpanded(!0))
              : k.setExpanded(!1);
            k = n;
            break;
          case "SEP":
            k &&
              ("CATEGORY" == k.tagName.toUpperCase()
                ? g.add(
                    new Blockly.Toolbox.TreeSeparator(d.treeSeparatorConfig_)
                  )
                : ((n = parseFloat(n.getAttribute("gap"))),
                  isNaN(n) ||
                    ((m = parseFloat(k.getAttribute("gap"))),
                    (n = isNaN(m) ? n : m + n),
                    k.setAttribute("gap", n))));
            break;
          case "BLOCK":
          case "SHADOW":
            g.blocks.push(n), (k = n);
...
Blockly.Toolbox.TreeControl.prototype.createNode = function (a) {
  return new Blockly.Toolbox.TreeNode(
    this.toolbox_,
    a
      ? module$contents$goog$html$SafeHtml_SafeHtml.htmlEscape(a)
      : module$contents$goog$html$SafeHtml_SafeHtml.EMPTY,
    this.getConfig(),
    this.getDomHelper()
  );
...
Blockly.createMainWorkspace_ = function (a, b) {
  ...
  b.readOnly ||
    ...
    c.addChangeListener(function () {
      if (Blockly.dragMode_ == Blockly.DRAG_NONE) {
        var d = c.getMetrics(),
          e = d.viewLeft + d.absoluteLeft,
          f = d.viewTop + d.absoluteTop;
        if (
          d.contentTop < f ||
          d.contentTop + d.contentHeight > d.viewHeight + f ||
          d.contentLeft < (b.RTL ? d.viewLeft : e) ||
          d.contentLeft + d.contentWidth >
            (b.RTL ? d.viewWidth : d.viewWidth + e)
        )
          for (var g = c.getTopBlocks(!1), h = 0, k; (k = g[h]); h++) {
            var l = k.getRelativeToSurfaceXY(),
              ...
              m = f + 25 - n.height - l.y;
            0 < m && k.moveBy(0, m);
            m = f + d.viewHeight - 25 - l.y;
            0 > m && k.moveBy(0, m);
            m = 25 + e - l.x - (b.RTL ? 0 : n.width);
            0 < m && k.moveBy(m, 0);
            l = e + d.viewWidth - 25 - l.x + (b.RTL ? n.width : 0);
            0 > l && k.moveBy(l, 0);
          }
      }
    });
...
Blockly.init_ = function (a, b) {
  var c = a.options,
    d = a.getParentSvg();
  Blockly.bindEvent_(d, "contextmenu", null, function (e) {
  ...
  c.languageTree &&
    (a.toolbox_
      ...
      : a.flyout_ &&
        (a.flyout_.init(a),
        a.flyout_.show(c.languageTree.childNodes),
        a.flyout_.scrollToStart(),
        (a.scrollX = a.flyout_.width_),
        c.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT && (a.scrollX *= -1),
        a.translate(a.scrollX, 0)));
  c.hasScrollbars &&
    ((a.scrollbar = new Blockly.ScrollbarPair(a)), a.scrollbar.resize());
  c.hasSounds && Blockly.inject.loadSounds_(c.pathToMedia, a);
};
...
Blockly.asyncSvgResize = function (a) {
  Blockly.svgResizePending_ ||
    (a || (a = Blockly.getMainWorkspace()),
    (Blockly.svgResizePending_ = !0),
    setTimeout(function () {
      Blockly.svgResize(a);
    }, 0));
};
...
Blockly.svgResize = function (a) {
  for (Blockly.svgResizePending_ = !1; a.options.parentWorkspace; )
